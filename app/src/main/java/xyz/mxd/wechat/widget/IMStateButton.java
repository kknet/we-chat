...
public class IMStateButton extends AppCompatButton {
    ...
    public IMStateButton(Context context) {
        this(context, null);
    }

    public IMStateButton(Context context, AttributeSet attrs) {
        this(context, attrs, androidx.appcompat.R.attr.buttonStyle);
    }

    public IMStateButton(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void setup(AttributeSet attrs) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.IMStateButton);
        ...
        mNormalTextColor = a.getColor(R.styleable.IMStateButton_normalTextColor, mDefaultNormalTextColor);
        mPressedTextColor = a.getColor(R.styleable.IMStateButton_pressedTextColor, mDefaultPressedTextColor);
        mUnableTextColor = a.getColor(R.styleable.IMStateButton_unableTextColor, mDefaultUnableTextColor);
        setTextColor();

        //set animation duration
        mDuration = a.getInteger(R.styleable.IMStateButton_animationDuration, mDuration);
        mStateBackground.setEnterFadeDuration(mDuration);
        mStateBackground.setExitFadeDuration(mDuration);

        //set background color
        mNormalBackgroundColor = a.getColor(R.styleable.IMStateButton_normalBackgroundColor, 0);
        mPressedBackgroundColor = a.getColor(R.styleable.IMStateButton_pressedBackgroundColor, 0);
        mUnableBackgroundColor = a.getColor(R.styleable.IMStateButton_unableBackgroundColor, 0);
        ...
        //set radius
        mRadius = a.getDimensionPixelSize(R.styleable.IMStateButton_radius, 0);
        mRound = a.getBoolean(R.styleable.IMStateButton_IMRound, false);
        ...
        //set stroke
        mStrokeDashWidth = a.getDimensionPixelSize(R.styleable.IMStateButton_strokeDashWidth, 0);
        mStrokeDashGap = a.getDimensionPixelSize(R.styleable.IMStateButton_strokeDashWidth, 0);
        mNormalStrokeWidth = a.getDimensionPixelSize(R.styleable.IMStateButton_normalStrokeWidth, 0);
        mPressedStrokeWidth = a.getDimensionPixelSize(R.styleable.IMStateButton_pressedStrokeWidth, 0);
        mUnableStrokeWidth = a.getDimensionPixelSize(R.styleable.IMStateButton_unableStrokeWidth, 0);
        mNormalStrokeColor = a.getColor(R.styleable.IMStateButton_normalStrokeColor, 0);
        mPressedStrokeColor = a.getColor(R.styleable.IMStateButton_pressedStrokeColor, 0);
        mUnableStrokeColor = a.getColor(R.styleable.IMStateButton_unableStrokeColor, 0);
        setStroke();
